...
import restaurant.DessertDishes;
import restaurant.KFC;
import restaurant.NonVegDishes;
import restaurant.VegDishes;
				...
				case 'b':
					...
					do {
						...
						System.err.println(" a. Grilled Chicken Rs-[" + nVeg.GRILLEDCHICKEN
								+ "] \n b. Mutton Korma  Rs-[" + nVeg.MOTTONKORMA + "]\n c. Fish Biryani Rs-["
								+ nVeg.FISHBIRIYANI + "] \n d. Chicken Biryani Rs-[" + nVeg.CHICKENBIRIYANI
								+ "]\n e. Egg Biryani  Rs-[" + nVeg.EGGBIRIYANI + "]");
						char itemChoice = sc.next().charAt(0);
						if (itemChoice == 'a') {
							System.out.println("Quantity ?");
